...
#' @import KEGG.db
#' 
#' @description This function outputs the groups, GO terms and pathways plot for the enrichment based on R package clusterProfiler, org.Mm.eg.db (Mouse for example) and KEGG.db.
#' 
